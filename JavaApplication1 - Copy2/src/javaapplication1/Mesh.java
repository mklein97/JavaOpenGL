...
public class Mesh {
    ...
    void init(String path){
        try {
            ...
            String s;
            s = raf.readUTF();
            if( !"november 7, 2017".equals(s)){ //  !s.equals("mesh0"))
            ...
            glBufferData(GL_ARRAY_BUFFER,ndata.length,ndata,GL_STATIC_DRAW);
            glVertexAttribPointer(Program.NORMAL_INDEX, 3, GL_FLOAT,
                    false, 3*4, 0);
