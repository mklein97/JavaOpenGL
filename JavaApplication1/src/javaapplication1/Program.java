...
import static etgg.GL.GL_SAMPLER_CUBE;
...
public class Program {
    ...
    static final int TANGENT_INDEX = 4;
    ...
    class samplerCubeSetter extends Setter {
        ...
        samplerCubeSetter(String n, int i, int size, int texunit) {
            super(n, i);
            this.size = size;
            this.texunit = texunit;
        }
    ...
    void setupUniformSetters() {
        ...
        for (int i = 0; i < numuniforms; ++i) {
            ...
            if (type == GL_FLOAT_MAT4 && size == 1) {
                ...
                texcount += size;
            } else if (type == GL_SAMPLER_CUBE && size >= 1) {
                uniforms.put(name, new samplerCubeSetter(name, loc, size, texcount));
                texcount += size;
