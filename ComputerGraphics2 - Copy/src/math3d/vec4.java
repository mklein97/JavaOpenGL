...
/** A class for a 4 dimensional vector */
public class vec4  implements Cloneable,Comparable< vec4 >{
    /** The x data field */
    public float x = 0.0f ;
    /** The y data field */
    public float y = 0.0f ;
    ...
    /** Construct a vec4 from the given values. */
    public vec4 ( vec4  xyzw_){
        x = xyzw_.x ;
        y = xyzw_.y ;
        z = xyzw_.z ;
        w = xyzw_.w ;
    ...
    /** Construct a vec4 from the given values. */
    public vec4 ( vec2  xy_, double z_, double w_){
        x = xy_.x ;
        y = xy_.y ;
        z = (float) z_;
        w = (float) w_;
    ...
    /**Get one of the fields.
        @param i Field to get (may be one of  [0, 1, 2, 3] )
        @return The value
     */
    ...
    /**Set one of the fields.
        @param i Field to set (may be one of  [0, 1, 2, 3] )
        @param v The value
     */
    ...
    /**Compute the dot product of this vec4 with another vec4 .*/
    public float dot( vec4  o){
        return this.x * o.x+this.y * o.y+this.z * o.z+this.w * o.w ;
    }
    /**Compute the sum of this vec4 with another vec4 .*/
    public vec4 add( vec4  o){
        return new vec4 ( this.x + o.x,this.y + o.y,this.z + o.z,this.w + o.w );
    }
    /**Compute the difference between this vec4 and another vec4 .*/
    public vec4 sub( vec4  o){
        return new vec4 ( this.x - o.x,this.y - o.y,this.z - o.z,this.w - o.w );
    }
    /**Compute the componentwise product of this vec4 and another vec4 .*/
    ...
    /** Return the negation of this vec4 */
    public vec4 neg(){
        return this.mul(-1.0f);
    }
    /**Compute the vector-matrix product.*/
    public vec4 mul( mat4 o){
        vec4  R = new vec4 ();
        R.x = this.x * o.get(0,0)+this.y * o.get(1,0)+this.z * o.get(2,0)+this.w * o.get(3,0) ;
        R.y = this.x * o.get(0,1)+this.y * o.get(1,1)+this.z * o.get(2,1)+this.w * o.get(3,1) ;
        R.z = this.x * o.get(0,2)+this.y * o.get(1,2)+this.z * o.get(2,2)+this.w * o.get(3,2) ;
        R.w = this.x * o.get(0,3)+this.y * o.get(1,3)+this.z * o.get(2,3)+this.w * o.get(3,3) ;
        return R;
    }
    public boolean equals( vec4 o){
