...
public class Main {
    ...
    static Program prog, deferredPass1Program, deferredPass2Program;
...
//                        mouseButtonDown = true;
    ...
    public static void draw() {
        ...
        fbo.bind(true);
        Program.current.setUniform("blurColorScale", 3);
        Program.current.setUniform("lightPosition", new vec4(
                world.player.lcs.position, 1.0));
    ...
    public static void main(String[] args) {
        ...
        shadowbuffer = new Framebuffer2D(WIN_WIDTH, WIN_HEIGHT, GL_RGBA32F, 1);
